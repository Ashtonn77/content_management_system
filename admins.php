         ...
         <?php
            if (isset($_POST['submit'])) {
                ...
                if (empty($username) || empty($password) || empty($confirmPassword)) {
                    ...
                    $sql = "INSERT INTO admins(datetime,username,password,aname,addedby, aheadline, abio, aimage)";
                    $sql .= "VALUES(:DateTime,:Username,:Password,:Aname,:AddedBy,:Aheadline,:Abio,:Aimage)";
                    ...
                    $stmt->bindValue(':Aheadline', '');
                    $stmt->bindValue(':Abio', '');
                    $stmt->bindValue(':Aimage', 'avatar.png');
                                ...
                                ?>
                                 <tbody>
                                     <tr>
                                         ...
                                         <td><a class="btn btn-danger btn-sm" href="deleteAdmin.php?id=<?= $adminId ?>">Delete</a></td>
